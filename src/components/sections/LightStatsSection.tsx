...
export const LightStatsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-16 sm:py-20 lg:py-24 px-6 sm:px-12 bg-white text-zinc-900 border-y border-zinc-200 relative overflow-hidden">
      <div className="max-w-[1700px] mx-auto space-y-16">
        {/* Header */}
        <div className="gsap-stats-header flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-zinc-300 pb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {STATS.map((stat, idx) => (
            <div
              key={idx}
              className="gsap-stats-card p-8 rounded-3xl bg-zinc-50 border border-zinc-200 space-y-4 hover:border-zinc-900 transition-colors"
            >
              ...
              <div className="text-5xl sm:text-7xl font-outfit font-black tracking-tighter text-zinc-900">
