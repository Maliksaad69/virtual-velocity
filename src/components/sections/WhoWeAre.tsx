...
export const WhoWeAre = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-0 -left-24 sm:-left-40 w-[320px] h-[320px] sm:w-[560px] sm:h-[560px] rounded-full bg-emerald-100/60 blur-[120px] sm:blur-[170px] pointer-events-none" />
      <div className="absolute bottom-0 -right-24 sm:-right-40 w-[320px] h-[320px] sm:w-[560px] sm:h-[560px] rounded-full bg-emerald-100/50 blur-[120px] sm:blur-[170px] pointer-events-none" />

      <div className="relative z-10 max-w-[1700px] mx-auto px-5 sm:px-12 py-14 sm:py-24 lg:py-28">
        {/* Eyebrow meta row */}
        <motion.div
          ...
          className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 border-b border-zinc-200 pb-5 sm:pb-6 text-[11px] sm:text-xs font-mono uppercase tracking-[0.28em] text-zinc-700"
        >
          <span className="flex items-center gap-2 font-extrabold text-emerald-600">
            <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            Who We Are
          </span>
          <span className="hidden sm:inline text-zinc-500">( The Manifesto )</span>
        </motion.div>
        ...
        <motion.h2
          ...
          className="mt-8 sm:mt-14 text-[2rem] sm:text-6xl md:text-7xl lg:text-[5.2rem] font-black uppercase text-zinc-900 tracking-tighter leading-[1.02] sm:leading-[0.92]"
        >
          We are{" "}
          ...
          <span
            ...
            style={{ WebkitTextStroke: "1.2px rgba(24, 24, 27, 0.4)" }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 mt-10 sm:mt-16 pt-8 sm:pt-12 border-t border-zinc-200">
          <motion.p
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.9, ease: EASE, delay: 0.1 }}
            className="md:col-span-7 text-xl sm:text-2xl lg:text-3xl font-light text-zinc-800 leading-[1.6] sm:leading-[1.55]"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 mt-8 sm:mt-14">
          <motion.p
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.9, ease: EASE, delay: 0.1 }}
            className="md:col-span-7 text-base sm:text-lg text-zinc-700 font-normal leading-relaxed sm:leading-[1.85]"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.9, ease: EASE, delay: 0.15 }}
            className="md:col-span-5 p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-zinc-900 text-white relative overflow-hidden"
          >
            ...
            <p className="relative z-10 mt-3 sm:mt-4 text-lg sm:text-2xl lg:text-[1.7rem] font-black uppercase tracking-tight leading-[1.15] sm:leading-[1.1]">
