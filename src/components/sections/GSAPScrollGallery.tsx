      ...
      <div className="max-w-[1700px] w-full mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-zinc-200 pb-4 sm:pb-6 gap-4 z-10">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2 items-center">
            <span className="text-[10px] sm:text-xs font-outfit font-bold text-zinc-700 mr-1 flex items-center gap-1">
            ...
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`text-[10px] sm:text-xs font-outfit px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full border transition-all duration-300 whitespace-nowrap ${
                  activeCategory === cat
