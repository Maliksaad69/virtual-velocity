...
const PROJECTS = [
  {
    ...
    summary: 'Custom Shopify Plus overhaul coupled with creative performance ad production that turned cold social traffic into loyal repeat customers.',
    deliverables: ['Custom Shopify Store', 'TikTok & Meta Creatives', 'Retargeting Architecture', 'Conversion Audit'],
    metrics: [{ label: 'Revenue Growth', value: '+180%' }, { label: 'Customer LTV', value: '+45%' }, { label: 'ROAS', value: '4.8x' }]
  },
  {
    num: '02', id: 'dailydeli',
    title: 'DAILY DELI CO.',
    ...
    summary: 'High-energy viral campaign rollout across TikTok, Instagram, and local paid channels — increasing foot traffic and online orders.',
    deliverables: ['Short-form Video Reels', 'PPC Campaign Setup', 'Local Geo-targeting', 'Influencer Strategy'],
    metrics: [{ label: 'Total Reach', value: '4.2M' }, { label: 'Engagement Rate', value: '11.4%' }, { label: 'Cost Per Lead', value: '-42%' }]
  },
  {
    num: '03', id: 'aura',
    title: 'AURA BEAUTY',
    category: 'BRANDING / ART DIRECTION / PACKAGING',
    result: '100% CUSTOM IDENTITY',
    ...
    metrics: [{ label: 'Retail Stockists', value: '35+' }, { label: 'Brand Value', value: 'Top 5%' }, { label: 'Press Features', value: '+300%' }]
  },
  {
    num: '04', id: 'samad',
    title: 'SAMAD GROUP TECH',
    category: 'DIGITAL EXPERIENCE / WEB / UX',
    result: '2.4s → 0.4s LOAD TIME',
    image: '/images/work_samad.png',
    summary: 'Re-engineering enterprise digital experience with rapid page loading speeds and elegant, high-converting product showcase.',
    deliverables: ['Custom Next.js Web App', 'Design System', 'Headless CMS', 'Performance Audit'],
    metrics: [{ label: 'Page Speed', value: '0.4s' }, { label: 'Form Inquiries', value: '+140%' }, { label: 'Bounce Rate', value: '-38%' }]
  }
];
      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            ...
            >
              <button className="close-drawer-btn" onClick={() => setSelectedProject(null)}>
                <X size={22} />
              </button>
